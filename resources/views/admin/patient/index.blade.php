...
@endif
<form action="{{ url('admin/patient/search')}}" method="get">
    ...
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{$p -> doctor}}</td>
          <td>
            <a class="btn btn-info btn-sm" href='{{ url("admin/patient/update/$p->id") }}'><i class="fas fa-pencil-alt"></i> Edit</a>
          </td>
        </tr>
        @endforeach
      </tbody>
    ...
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{$p -> status}}</td>
          <td>{{$p -> doctor}}</td>
          <td><a class="btn btn-info btn-sm" href='{{ url("/admin/patient/createExam/$p->id") }}'><i class="fas fa-pencil-alt"></i> Re-Exam</a></td>
        </tr>
        @endforeach
      </tbody>
