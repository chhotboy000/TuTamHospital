    ...
    <div class="row">
        <div class="offset-md-3 col-md-6">
            <div class="card card-primary">
                ...
                <form role="form" action="{{url('admin/pharma/postCreate')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="txt-expire" value="{{ old('expire') }}" name="expire" placeholder="Input Name" required>
                        @error('expire')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        {{-- @if ($errors->has('date'))
