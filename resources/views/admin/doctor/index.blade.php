    ...
    <table class="table table-bordered table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td >{{ $p -> symtomp }}</td>
          <td >
            <a class="btn btn-info btn-sm" href='{{ url("/admin/doctor/createTreat/$p->id") }}'><i class="fas fa-pencil-alt"></i> Exam</a>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td >
            ...
            @endphp
            <a class="btn btn-info btn-sm" href='{{ url("/admin/doctor/editTreat/$id") }}'><i class="fas fa-pencil-alt"></i> Edit Exam</a>
          </td>
        </tr>
        @endforeach
      </tbody>
