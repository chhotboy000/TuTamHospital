            ...
            <div class="row">
                <div class="offset-md-3 col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{ url('admin/doctor/postCreate') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="line-height: 20px; height:20px; font-size:20px; text-align:left;">
                                                <input type="text"  id="trWeight"   style="width:100px;line-height:20px; padding-right:2px;" name="weight"><span id="errWei">kg</span>
                                                @error('weight')
                            ...
                            @enderror
                                            ...
                                            <td style="line-height: 20px; height:20px; font-size:20px; text-align:left;">
                                                <input type="text"   id="trHeight"  style="width:100px;line-height:20px; padding-right:2px;" name="height"><span id="errHei">cm</span>
                                                @error('height')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="line-height: 20px; height:20px; font-size:20px; text-align:left;">
                                                <input type="text"   id="trTemp"  style="width:100px;line-height:20px; padding-right:2px;" name="temp"><span id="errTem">Celcius</span>
                                                @error('temp')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </td>
