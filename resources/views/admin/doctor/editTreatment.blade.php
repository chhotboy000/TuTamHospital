            ...
            <div class="row">
                <div class="offset-md-3 col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{ url('admin/doctor/postTreat') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="line-height: 20px; height:20px; font-size:20px; text-align:left;">
                                                <input type="text"  id="trWeight"   style="width:100px;line-height:20px; padding-right:2px;" name="weight" value="{{$treat->weight}}" readonly><span id="errWei">kg</span>
                                            </td>
                                            <td style="line-height: 20px; height:20px; font-size:20px; text-align:left;">
                                                <label for="txt-name" style="font-family: Source Sans Pro; font-weight:normal">Height</label>
                                            </td>
                                            <td style="line-height: 20px; height:20px; font-size:20px; text-align:left;">
                                                <input type="text"   id="trHeight"  style="width:100px;line-height:20px; padding-right:2px;" name="height" value="{{$treat->height}}" readonly><span id="errHei">cm</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="line-height: 20px; height:20px; font-size:20px; text-align:left;">
                                            ...
                                            <td style="line-height: 20px; height:20px; font-size:20px; text-align:left;">
                                                <input type="text"   id="trTemp"  style="width:100px;line-height:20px; padding-right:2px;" name="temp" value="{{$treat->temp}}" readonly><span id="errTem">Celcius</span>
                                            </td>
                                        </tr>
