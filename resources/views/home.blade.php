...
<link rel="stylesheet" href="{{asset('css_index/font-awesome.min.css')}}">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <div class="team-thumb wow fadeInUp" data-wow-delay="0.2s">
                              <img src="{{asset('images_index/team-image1.jpg')}}" class="img-responsive" alt="">
                                   ...
                                   <div class="team-info">
                                        <h3>Trần Bình Nguyên Bách</h3>
                                        <p>General Principal</p>
                                        <div class="team-contact-info">
                                             <p><i class="fa-solid fa-phone"></i> 010-020-0120</p>
                    ...
                    <div class="col-md-4 col-sm-6">
                         <div class="team-thumb wow fadeInUp" data-wow-delay="0.6s">
                              <img src="{{asset('images_index/team-image3.jpg')}}" class="img-responsive" alt="">
                                   ...
                                   <div class="team-info">
                                        <h3>Huỳnh Đăng Khoa </h3>
                                        <p>otorhinolaryngology</p>
                                        <div class="team-contact-info">
                                             <p><i class="fa fa-phone"></i> 010-040-0140</p>
                                             <p><i class="fa-solid fa-envelope"></i> <a href="#">cardio@company.com</a></p>
                                        </div>
                                        <ul class="social-icon">
